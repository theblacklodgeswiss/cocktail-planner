...
/// Dialog to generate and share a WhatsApp offer message with a 14-day
/// share link.
///
/// The middle "cocktail commentary" part is generated by Gemini.
/// The share link is created via [createShareLink] and appended to the
/// message, which is then copied to the clipboard and opened in WhatsApp.
